...
def main():
    if not TELEGRAM_BOT_TOKEN:
        raise SystemExit(
            "TELEGRAM_BOT_TOKEN topilmadi. .env faylini yoki Render Environment'ni tekshiring."
        )

    # Ba'zi platformalarda (Python 3.12+) asosiy oqimda hali asyncio event loop
    # o'rnatilmagan bo'ladi, bu esa python-telegram-bot ishga tushishida
    # "There is no current event loop in thread 'MainThread'" xatosiga olib keladi.
    # Shu sababli uni qo'lda yaratib, o'rnatib qo'yamiz.
    import asyncio
    try:
